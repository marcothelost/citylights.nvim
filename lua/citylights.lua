...
Group.new('Comment',   colors.BlueGrey, none, plain) 
...
Group.new('SpecialComment', colors.BlueGrey, none, plain)
...
Group.new("CursorLine",  none,          colors.LightGrey,     plain)
...
Group.new("Normal",      none,          colors.Black,         plain)
